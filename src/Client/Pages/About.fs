...
type About =
    static member Main() =
        let effectiveDate = " [Insert Date]"
        let websiteUrl = "[insert website URL]"
        let contactEmail = "[insert contact email]"
        Components.MainCard.Main [
            Html.div [
                ...
                prop.children [
                    ...
                    Html.p $"If you have any questions or concerns about our privacy practices, please contact us at {contactEmail}"
                    ...
                    Html.p $"If you have any questions or concerns about our Privacy Policy, please contact us at {contactEmail}."
                ]
            ]
        ]